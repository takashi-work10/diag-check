        ...
        <Radio
          ...
          icon={
            <RadioButtonUncheckedIcon
              sx={{ fontSize: { xs: option.size * 0.45, sm: option.size * 0.7, md: option.size * 1.1 }, color: option.color, p: 0 }}
            />
          }
          checkedIcon={
            <SvgIcon sx={{ fontSize: { xs: option.size * 0.45, sm: option.size * 0.7, md: option.size * 1.1 }, color: option.color, fill: option.color, p: 0 }}>
